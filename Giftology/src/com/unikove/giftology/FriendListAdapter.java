...
public class FriendListAdapter extends ArrayAdapter<FriendDetail> {
	...
	public FriendListAdapter(Activity context,
			ArrayList<FriendDetail> description) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.friendscreen_rowitem, null,
				true);
	...
	/*
	 * private static String pad(int c) { if (c >= 10) return String.valueOf(c);
