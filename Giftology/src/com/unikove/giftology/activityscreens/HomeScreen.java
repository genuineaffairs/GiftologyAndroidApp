...
public class HomeScreen extends TabActivity {
	...
	private static final String[] PERMISSIONS = new String[] {
			"offline_access", "user_location", "user_birthday",
			"publish_stream", "user_photos", "publish_checkins",
			"photo_upload", "friends_birthday", "read_friendlists",
			"friends_location", "manage_friendlists" };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * prefs = getApplicationContext().getSharedPreferences("PREF_NAME",
		 * Context.MODE_PRIVATE);
		 * 
		 * Utility.mFacebook = new Facebook(APP_ID); // Create the Facebook
		 * Object using the app id. Utility.mAsyncRunner = new
		 * AsyncFacebookRunner(Utility.mFacebook);
		 * SessionStore.restore(Utility.mFacebook, this);
		 * restoreCredentials(Utility.mFacebook); if
		 * (Utility.mFacebook.isSessionValid()) { if_fb_loggedin(); } else{
		 * if_fb_not_loggedin(); }
		 */
	}
	...
	public void onResume() {
		...
		Utility.mFacebook = new Facebook(APP_ID); // Create the Facebook Object
													// using the app id.
	...
	public void if_fb_loggedin() {
		// Toast.makeText(HomeScreen.this, "Events Screen",
		...
		try {
			...
			// Toast.makeText(HomeScreen.this, "No notifications available",
	...
	public void if_fb_not_loggedin() {
		...
		// Toast.makeText(HomeScreen.this, "Home Screen",
		// Toast.LENGTH_LONG).show();
	}
	...
	private void callNotifications() {
		...
		try {
			...
			alarmManager.setRepeating(AlarmManager.RTC, Calendar.getInstance()
					.getTimeInMillis(), RECEIVERCALLDURATION, pendingIntent);
		} catch (Exception e) {
	...
	public void initialize_homeScreen() {
		...
		text_below_fbConnect = (TextView) findViewById(R.id.textView);
		text_below_fbConnect.setTypeface(tf);
		...
		fb_connect.setOnClickListener(new ImageView.OnClickListener() {
			public void onClick(View v) {
				if (ConnectionUtility
					...
					GAUtility.trackEvent(HomeScreen.this, "Home Screen",
							"Login Button Clicked", "FB Button", (long) 0);
					Utility.mFacebook.authorize(HomeScreen.this, PERMISSIONS,
							new LoginDialogListener());
				} else {

					GAUtility.trackEvent(HomeScreen.this, "Home Screen",
							"Login Failed/Internet", "FB Button", (long) 0);

					Toast.makeText(HomeScreen.this, "Internet not available",
							Toast.LENGTH_SHORT).show();
				}
			}
		});
	...
	class LoginDialogListener implements DialogListener {
		public void onComplete(Bundle values) {
			...
			try {
				...
				String url = "http://graph.facebook.com/" + userName
						+ "/picture?type=large";
			...
			// Log.i("Giftology.Debug",getApplicationContext().getSharedPreferences("PREF_NAME",
		...
		public void onFacebookError(FacebookError error) {
			...
			GAUtility
					.trackEvent(HomeScreen.this, "Home Screen",
							"Clicked FB Button/Facebook Failure", "FB Button",
							(long) 0);
		...
		public void onError(DialogError error) {
			showToast("Authentication with Facebook failed!");
			GAUtility.trackEvent(HomeScreen.this, "Home Screen",
					"Clicked FB Button/Facebook Error", "FB Button", (long) 0);
		...
		public void onCancel() {
			...
			GAUtility.trackEvent(HomeScreen.this, "Home Screen",
					"Clicked FB Button/Facebook Cancel", "FB Button", (long) 0);
	 ...
	 * 
	 * String userName=jObject.getString("username"); String
	 * url="http://graph.facebook.com/" + userName + "/picture?type=large" ;
	 * editor.putString("UserPicUrl", url);
	 * 
	 * editor.commit(); Log.i("Giftology.Debug",prefs.getAll().toString());
	 * runOnUiThread(new Runnable() { public void run() {
	 * showToast("Data Saved Done"); } }); } catch(Exception e){
	 * Log.i("Giftology.Debug","error"); } return null; }
	 * 
