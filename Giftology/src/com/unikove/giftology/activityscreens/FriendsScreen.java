...
import com.unikove.giftology.FriendListAdapter;
...
public class FriendsScreen extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		startTimer();
		pd = ProgressDialog.show(FriendsScreen.this, "", "Loading Friends...",
				true, false);
		...
		search.setOnClickListener(new ImageView.OnClickListener() {
			public void onClick(View v) {
				...
				flad = new FriendListAdapter(FriendsScreen.this,
						al_friend_search);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.txtAbout:
			if (ConnectionUtility.isInternetAvailable(getApplicationContext())) {
				...
				Toast.makeText(FriendsScreen.this, "Internet not available",
	...
	private class LogoutAsynTask extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			try {
				pd = ProgressDialog.show(FriendsScreen.this, "",
		...
		protected String doInBackground(String... params) {
			try {
				...
				GAUtility.trackEvent(FriendsScreen.this, "Friends Screen",
		...
		protected void onPostExecute(String result) {
			if (dataSavedLogout) {
				...
				startActivity(new Intent(FriendsScreen.this, HomeScreen.class)
	...
	private class AboutUSAsync extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			String result = "";
			GAUtility.trackEvent(FriendsScreen.this, "Friend Screen",
					"About Us Clicked", "About US", (long) 0);
	...
	public void populate_array_list() {
		try {
			if (!(api_Response.equals(""))) {
				...
				// Toast.makeText(FriendsScreen.this,jsonArray.length()+"",
				// Toast.LENGTH_LONG).show();
			}
		} catch (JSONException e) {
			e.printStackTrace();
		...
		TimerTask task = new TimerTask() {
			public void run() {
				...
				String currentactivity = taskInfo.get(0).topActivity
						.getClassName();
				if (currentactivity
						.equals("com.unikove.giftology.activityscreens.FriendsScreen")) {
					if (progressRunning) {
						if (pd != null) {
							pd.dismiss();
							runOnUiThread(new Runnable() {
